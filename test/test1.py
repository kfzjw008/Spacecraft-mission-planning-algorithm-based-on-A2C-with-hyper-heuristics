...
start_time = time.time()
#timesss,X,Best_Pos, Best_fitness, IterCurve = PSO(pop, dim, ub, lb, fun1, vmax, vmin, maxIter,X)#527
#timesss,X,Best_Pos, Best_fitness, IterCurve = GWO(pop, dim, ub, lb, fun1, maxIter,X)#556
#timesss,X,Best_Pos, Best_fitness, IterCurve = SCA(pop, dim, ub, lb, fun1, maxIter,X)#0.5-731
timesss,X,Best_Pos, Best_fitness, IterCurve = FOA(pop, dim, ub, lb, fun1, maxIter,X,city_coordinates)#598
